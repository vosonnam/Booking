						...
						<div class="booking-form">					
							<form method="post">
								...
								<div class="input-box">
									...
									<input type="text" name="phone" pattern="(84|0[3|5|7|8|9])+([0-9]{8})\b" required="" placeholder="Nhập số điện thoại">
								</div>
								<div class="input-box">
									<i></i>
								...
								<div class="btn-box">
                                    <button type="submit" name="event" value="booking">Đặt Lịch Hẹn</button>
								</div>						
							</form>
						</div>
					</div>
